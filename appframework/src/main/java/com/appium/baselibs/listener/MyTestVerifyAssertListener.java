...
import com.appium.baselibs.MyVerifyAssert;
      ...
      if (verificationFailures.size() > 0) {
        ...
        if (size == 1) {
          ...
          StringBuilder failureMessage =
              new StringBuilder("Multiple failures (").append(size).append("):\n");
          for (int i = 0; i < size; i++) {
            failureMessage.append("Failure ").append(i + 1).append(" of ").append(size)
                .append(":\n");
