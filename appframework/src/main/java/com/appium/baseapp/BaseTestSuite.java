...
public class BaseTestSuite {
  ...
  /*
   * protected boolean isRunAll = true; This property will control which row in a data file to run
   * It will work together with utilityLib.Tools.getDataByTableName executeRow = 0 will execute all
   * test cases in the datatable
   */
